...
function Banner({mousePosition}) {
    ...
    ></div> */}
            ...
            {/* Menu */}
            <div className={`text-overlay ${menuOpen ? "open" : ""}`}>
                <div className="text-content">
                    <h1 dangerouslySetInnerHTML={{ __html: images[currentIndex].text }} />
                    <p>{images[currentIndex].pera}</p>
                    <button className="banner_btn">
                        Contact US <PiFlipVerticalLight className="btn_icon" />
                    </button>
                </div>

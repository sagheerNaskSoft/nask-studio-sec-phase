  ...
  return (
    <div className='footer py-5'>
        ...
        <div className='container new-container'>
                ...
                <div className='d-flex justify-content-center'><Link className="link_footer">FAQs</Link><span className='mx-2'><div class="line">|</div></span><Link className="link_footer">Terms & Condtions</Link><span className='mx-2'><div class="line">|</div></span><Link className="link_footer">Privacy Policy</Link></div>
                <hr style={{borderColor:"white"}} className='my-5'/>

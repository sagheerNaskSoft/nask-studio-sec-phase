    ...
    return (
        <div className='shoot-section p-1'>
            <div className='container px-sm-3 px-4'>
                <h1 className='text-center my-lg-5  pt-lg-0 pt-4 pb-0 mt-4 mb-0'>Best Shoot</h1>
                <div className='row '>
                    <div className='col-lg-6 py-lg-5 pt-5 pb-0'>
                        <div class="col-lg-6">
                            <div class="front-img d-lg-none d-block mb-lg-5 mb-3">
                ...
                <div className='row'>
                    <div className='col-lg-6 py-lg-5 pt-5 pb-0'>
                        <div class="front-img d-lg-none d-flex justify-content-between mb-lg-5 mb-3">
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-6 py-lg-5 pt-5 pb-0'>
                        <div class="col-lg-6">
                            <div class="front-img w-100 h-100 d-lg-none d-block mb-lg-5 mb-3">
